                ...
                <>
                    <li className="nav-item">
                        <Link to={"/login"} className="nav-link pl-5 pr-3">
                            <FontAwesomeIcon className="mr-2" icon={faSignInAlt}/>LOG IN</Link>
                    </li>
                    <li className="nav-item">
        ...
        return (
            <div>
                <div id="header" className="container-fluid header-top d-none d-md-block pb-5 pt-5">
                    <img src="https://i.ibb.co/xCqfmZF/LV.jpg" className="rounded mx-auto d-block"/>
                </div>
                    ...
                    <nav id="navbar-main" className={`container navbar navbar-expand-lg bg-black text-white `}
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav mr-auto ">
                                <li className="nav-item">
                                    <Link to={"/"}><span className="nav-link pl-5 pr-5">NEW</span></Link>
                                </li>
                                <li className="nav-item">
                                    <Link to={{pathname: "/menu", state: {id: "all"}}}>
                                        <span className="nav-link pl-5 pr-5">MEN</span></Link>
                                </li>
                                <li className="nav-item">
                                    <Link to={"/contacts"}><span className="nav-link pl-5 pr-5">ABOUT US</span></Link>
                                </li>
                            </ul>
